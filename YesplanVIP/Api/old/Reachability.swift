...
////  YesplanVIP
////
////  Created by Techcc - FOH - Video on 10/11/18.
...
//        let selfReference = UnsafeMutableRawPointer(Unmanaged<Reachability>.passUnretained(self).toOpaque())
...
//            Unmanaged<Reachability>.fromOpaque(info).takeUnretainedValue().reachabilityChanged(flags: flags)
//        }
//        
