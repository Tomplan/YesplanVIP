...
//  YesplanVIP
//
//  Created by Tom Slegers on 24/02/2020.
...
//    let colors : [UIColor] = [.red,  .blue,  .orange, .purple]
    let colors : [UIColor] = [.yellow, .lightGray, .darkGray]
    var defaultColor : UIColor = UIColor.yellow
    
    var isUsrInteractionEnable : Bool = false
    var defaultbgColor: UIColor = UIColor.darkGray
    var loaderSize : CGFloat = 60.0
    /// **************** ******************  ////////// **************
