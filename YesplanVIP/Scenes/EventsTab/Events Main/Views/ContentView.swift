...
////  YesplanVIP
////
////  Created by Tom Slegers on 05/02/2020.
...
//    
//    var rkManager1 = RKManager(calendar: Calendar.current, minimumDate: Date(), maximumDate: Date().addingTimeInterval(60*60*24*3000), mode: 0)
////        .colorScheme(.dark)
//        
