...
class EDAttachmentsView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(EDAttachmentsViewCell.self, forCellWithReuseIdentifier: "EDAttachmentsViewCell")
        collectionView.register(EDAttachmentsViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "EDAttachmentsViewHeader")
    }
