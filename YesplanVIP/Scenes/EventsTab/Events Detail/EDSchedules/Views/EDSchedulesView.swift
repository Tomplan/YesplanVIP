...
class EDSchedulesView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(EDSchedulesViewCell.self, forCellWithReuseIdentifier: "EDSchedulesViewCell")
        collectionView.register(EDSchedulesViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "EDSchedulesViewHeader")
    }
