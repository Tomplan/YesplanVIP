...
class TasksDetailView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(TasksDetailViewCell.self, forCellWithReuseIdentifier: "TasksDetailViewCell")
        collectionView.register(TasksDetailViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "TasksDetailViewHeader")
    }
