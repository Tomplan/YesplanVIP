...
class TDAttachmentsView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(TDAttachmentsViewCell.self, forCellWithReuseIdentifier: "TDAttachmentsViewCell")
        collectionView.register(TDAttachmentsViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "TDAttachmentsViewHeader")
    }
