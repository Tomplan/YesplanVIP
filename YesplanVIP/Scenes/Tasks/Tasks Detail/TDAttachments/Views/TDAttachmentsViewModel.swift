...
//
//protocol TDAttachmentsViewModelDelegate: class {
//    func didSelect(taskAttachment: TaskAttachment)
//}

class TDAttachmentsViewModel: CollectionViewViewModel<TDAttachmentsViewCell, TaskAttachment> {
    
//    weak var delegate: TDAttachmentsViewModelDelegate?

    override func config(cell: TDAttachmentsViewCell , data: TaskAttachment, indexPath: IndexPath, grid: Grid) {
...
//        }
    ...
    override func size(data: TaskAttachment, indexPath: IndexPath, grid: Grid, view: UIView) -> CGSize {
//        print(grid.)
...
//class HorizontalTDAttachmentsViewModel: TDAttachmentsViewModel {
//
//    override func size(data: Resourcebooking, indexPath: IndexPath, grid: Grid, view: UIView) -> CGSize {
