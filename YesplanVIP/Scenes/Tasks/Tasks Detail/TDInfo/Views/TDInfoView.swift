...
class TDInfoView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(TDInfoViewCell.self, forCellWithReuseIdentifier: "TDInfoViewCell")
        collectionView.register(TDInfoViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "TDInfoViewHeader")
    }
