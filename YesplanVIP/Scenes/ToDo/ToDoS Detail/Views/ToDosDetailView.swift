...
class ToDosDetailView: UIView {
    ...
    convenience init() {
        ...
        collectionView.register(ToDosDetailViewCell.self, forCellWithReuseIdentifier: "ToDosDetailViewCell")
        collectionView.register(ToDosDetailViewHeader.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader , withReuseIdentifier: "ToDosDetailViewHeader")
    }
